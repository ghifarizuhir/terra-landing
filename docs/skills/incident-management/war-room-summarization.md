...
Chronological summarization of comments into 3 parts: what happened, current impact, next action. Input: timeline. Output: 23 sentences. Uses extractive summarization, no LLM recommendations. Trigger on war-room or >10 comments.
