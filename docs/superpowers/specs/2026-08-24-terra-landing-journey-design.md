...
Semua konten diambil dari fakta kode (`business-capabilities.md`), bukan marketing fluff. Setiap card berisi: icon, prefix badge monospace, judul, one-liner, 23 bullet capability, footer badge AI skill.
...
**Display strategy:**
- **Per-card badge:** tampilkan 12 skill relevan di footer card (pill dengan icon ✨ + label skill).
