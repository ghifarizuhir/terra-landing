        ...
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-0">
          ...
          <div className="relative bg-[#0f1115] border-t lg:border-t-0 lg:border-l border-white/10 p-6">
            ...
            <svg viewBox="0 0 360 160" className="w-full h-auto">
              ...
              <text x="320" y="77" textAnchor="middle" fontFamily="JetBrains Mono" fontSize="7" fill="#facc15">MAP</text>
              ...
              <text x="102" y="52" fontFamily="JetBrains Mono" fontSize="5" fill="#f59e0b">causes</text>
              <text x="102" y="115" fontFamily="JetBrains Mono" fontSize="5" fill="#ef4444">impacts</text>
            </svg>
            <div className="mt-3 flex gap-2 font-mono text-[9px] tracking-widest uppercase text-white/40">
              <span>8 managements</span>
              <span className="text-white/20">·</span>
              <span>one line, one skill each</span>
            </div>
          </div>
        </div>
      </div>
